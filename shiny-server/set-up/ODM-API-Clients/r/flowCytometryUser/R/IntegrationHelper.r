...
IntegrationHelper <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ...
      IntegrationHelperObject <- list()

      IntegrationHelperObject
    },
    fromJSON = function(IntegrationHelperJson) {
      self$`_raw_json` <- IntegrationHelperJson

      IntegrationHelperObject <- jsonlite::fromJSON(IntegrationHelperJson)
    },
    ...
    fromJSONString = function(IntegrationHelperJson) {
      self$`_raw_json` <- IntegrationHelperJson
