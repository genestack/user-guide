...
LibrarySPoTApi <- R6::R6Class(
  ...
  public = list(
    ...
    delete_library_group = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()

      body <- NULL
      urlPath <- "/libraries/group/{id}"
      if (!missing(`id`)) {
        urlPath <- gsub(paste0("\\{", "id", "\\}"), `id`, urlPath)
      }
    ...
    update_library = function(id, body, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
...
#' @param source 
#'
#' @export LibrarySPoTApi_add_libraries
#'
LibrarySPoTApi_add_libraries <- function(source, ...) {
  LibrarySPoTApi$new()$add_libraries(source, ...)
}
...
#'
#' @export LibrarySPoTApi_delete_library
#'
LibrarySPoTApi_delete_library <- function(id, ...) {
  LibrarySPoTApi$new()$delete_library(id, ...)
}
...
#' @param id Unique identifier (accession) of the object.
#'
#' @export LibrarySPoTApi_delete_library_group
#'
LibrarySPoTApi_delete_library_group <- function(id, ...) {
  LibrarySPoTApi$new()$delete_library_group(id, ...)
}
...
#'
#' @export LibrarySPoTApi_update_library
#'
LibrarySPoTApi_update_library <- function(id, body, ...) {
  LibrarySPoTApi$new()$update_library(id, body, ...)
}
