...
EXAMPLE_TEXT = '''example:
 ...
 python %(prog)s.py --host https://qa.magnum.genestack.com/ --study_accession GSF000160 --s3 aws_cred.json --token <token>
 
  python %(prog)s.py --host https://qa.magnum.genestack.com/ --study_accession GSF000160 --s3 aws_cred.json --token <token> --field 'Data Files / Raw' --field 'Data Files / Processed'
