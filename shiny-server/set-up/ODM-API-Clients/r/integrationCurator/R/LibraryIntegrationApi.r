...
LibraryIntegrationApi <- R6::R6Class(
  ...
  public = list(
    ...
    create_library_group_sample_group_link = function(source_id, target_id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()

      body <- NULL
      urlPath <- "/integration/link/library/group/{sourceId}/to/sample/group/{targetId}"
    ...
    create_library_sample_link = function(source_id, target_id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()

      body <- NULL
      urlPath <- "/integration/link/library/{sourceId}/to/sample/{targetId}"
      if (!missing(`source_id`)) {
        urlPath <- gsub(paste0("\\{", "sourceId", "\\}"), `source_id`, urlPath)
      }
    ...
    delete_library_group_sample_group_link = function(source_id, target_id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    delete_library_sample_link = function(source_id, target_id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
...
#'
#' @param source_id The ID (accession) of the library group object
#' @param target_id The ID (accession) of the sample group object
#'
#' @export LibraryIntegrationApi_create_library_group_sample_group_link
#'
LibraryIntegrationApi_create_library_group_sample_group_link <- function(source_id, target_id, ...) {
  LibraryIntegrationApi$new()$create_library_group_sample_group_link(source_id, target_id, ...)
}

#' Create a link between a library and a sample
#'
#' @param source_id The ID (accession) of the library object
#' @param target_id The ID (accession) of the sample object
#'
#' @export LibraryIntegrationApi_create_library_sample_link
#'
LibraryIntegrationApi_create_library_sample_link <- function(source_id, target_id, ...) {
  LibraryIntegrationApi$new()$create_library_sample_link(source_id, target_id, ...)
}
...
#' @param target_id The ID (accession) of the sample group object
#'
#' @export LibraryIntegrationApi_delete_library_group_sample_group_link
#'
LibraryIntegrationApi_delete_library_group_sample_group_link <- function(source_id, target_id, ...) {
  LibraryIntegrationApi$new()$delete_library_group_sample_group_link(source_id, target_id, ...)
}
...
#' @param target_id The ID (accession) of the sample object
#'
#' @export LibraryIntegrationApi_delete_library_sample_link
#'
LibraryIntegrationApi_delete_library_sample_link <- function(source_id, target_id, ...) {
  LibraryIntegrationApi$new()$delete_library_sample_link(source_id, target_id, ...)
}
