...
ValidationSummaryApi <- R6::R6Class(
  ...
  public = list(
    ...
    search_expression_data = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()

      body <- NULL
      urlPath <- "/studies/{id}/validation-summary"
      if (!missing(`id`)) {
...
#'
#' @export ValidationSummaryApi_search_expression_data
#'
ValidationSummaryApi_search_expression_data <- function(id, ...) {
  ValidationSummaryApi$new()$search_expression_data(id, ...)
}
