...
SampleSPoTApi <- R6::R6Class(
  ...
  public = list(
    ...
    add_atomic_sample = function(source, ...){
      args <- list(...)
      queryParams <- list()
    ...
    get_sample = function(id, returned_metadata_fields, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    get_sample_by_version = function(id, version, returned_metadata_fields, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
      ...
      body <- NULL
      urlPath <- "/samples/{id}/versions/{version}"
      if (!missing(`id`)) {
        urlPath <- gsub(paste0("\\{", "id", "\\}"), `id`, urlPath)
      }
    ...
    get_sample_versions = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()

      body <- NULL
      urlPath <- "/samples/{id}/versions"
      if (!missing(`id`)) {
        urlPath <- gsub(paste0("\\{", "id", "\\}"), `id`, urlPath)
      }
    ...
    search_samples = function(filter, query, search_specific_terms, returned_metadata_fields, sort, page_limit, page_offset, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    update_sample = function(id, body, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
...
#' \describe The supplied metadata object must be a JSON _object_ with non-empty strings as keys. These are interpreted as attribute names. The values should be either scalar JSON values (null, boolean, number or string), or an type-homogenous array of scalar values.}
#' }
#'
#' @export SampleSPoTApi_add_atomic_sample
#'
SampleSPoTApi_add_atomic_sample <- function(source, ...) {
  SampleSPoTApi$new()$add_atomic_sample(source, ...)
}
...
#' @param source 
#'
#' @export SampleSPoTApi_add_samples
#'
SampleSPoTApi_add_samples <- function(source, ...) {
  SampleSPoTApi$new()$add_samples(source, ...)
}
...
#'
#' @export SampleSPoTApi_delete_sample
#'
SampleSPoTApi_delete_sample <- function(id, ...) {
  SampleSPoTApi$new()$delete_sample(id, ...)
}
...
#'
#' @export SampleSPoTApi_get_sample
#'
SampleSPoTApi_get_sample <- function(id, returned_metadata_fields, ...) {
  SampleSPoTApi$new()$get_sample(id, returned_metadata_fields, ...)
}
...
#' @param returned_metadata_fields The parameter defines amount of metadata attributes to return:  1. \code{template} - return metadata attributes according to applied template, if object doesn’t have applied template default template will be used. This is the default for User endpoints. 2. \code{all} - return all metadata attributes with values and null attributes, if they are present in the applied template. This is the default for Curator endpoints.
#'
#' @export SampleSPoTApi_get_sample_by_version
#'
SampleSPoTApi_get_sample_by_version <- function(id, version, returned_metadata_fields, ...) {
  SampleSPoTApi$new()$get_sample_by_version(id, version, returned_metadata_fields, ...)
}
...
#' @param id Unique identifier (accession) of the object.
#'
#' @export SampleSPoTApi_get_sample_versions
#'
SampleSPoTApi_get_sample_versions <- function(id, ...) {
  SampleSPoTApi$new()$get_sample_versions(id, ...)
}
...
#' @param query Search for sample objects via a full-text query over all sample metadata fields. E.g. \code{Clozapine}
...
#' @param page_limit Maximum number of results to return. This value must be between 0 and 100 (inclusive).
...
#'
#' @export SampleSPoTApi_search_samples
#'
SampleSPoTApi_search_samples <- function(filter, query, search_specific_terms, returned_metadata_fields, sort, page_limit, page_offset, ...) {
  SampleSPoTApi$new()$search_samples(filter, query, search_specific_terms, returned_metadata_fields, sort, page_limit, page_offset, ...)
}
...
#'
#' @export SampleSPoTApi_update_atomic_metadata
#'
SampleSPoTApi_update_atomic_metadata <- function(id, body, ...) {
  SampleSPoTApi$new()$update_atomic_metadata(id, body, ...)
}
...
#' @param body Metadata in the form of \code{{key: value, key2: value2, ...}}
#'
#' @export SampleSPoTApi_update_sample
#'
SampleSPoTApi_update_sample <- function(id, body, ...) {
  SampleSPoTApi$new()$update_sample(id, body, ...)
}
