...
LinkageApi <- R6::R6Class(
  ...
  public = list(
    ...
    delete_link = function(first_id, second_id, first_type, second_type, ...){
      args <- list(...)
      queryParams <- list()
...
#'
#' @export LinkageApi_delete_link
#'
LinkageApi_delete_link <- function(first_id, second_id, first_type, second_type, ...) {
  LinkageApi$new()$delete_link(first_id, second_id, first_type, second_type, ...)
}
...
#' @param links 
#'
#' @export LinkageApi_save_links
#'
LinkageApi_save_links <- function(links, ...) {
  LinkageApi$new()$save_links(links, ...)
}
