    ...
    withTags({
        div(class="root",
            h2(
                ...
                div(class="report-title", 
                    HTML('<svg
                        class="report-icon"
                         ...
                         >
                         <path
                         d="M3 12C2.44772 12 2 11.5523 2 11L2 5C2 3.34315 3.34315 2 5 2L9.38197 2C9.76074 2 10.107 2.214 10.2764 2.55279L10.7236 3.44721C10.893 3.786 11.2393 4 11.618 4L16 4C17.1046 4 18 4.89543 18 6L18 11C18 11.5523 17.5523 12 17 12L3 12Z"
                         fill="#B6D477"
                         />
                         <path
                         d="M2 11C2 8.23858 4.23858 6 7 6H16C17.1046 6 18 6.89543 18 8V15C18 16.1046 17.1046 17 16 17H4C2.89543 17 2 16.1046 2 15V11Z"
                         fill="#6C990F"
                         />
                         <path
                         fill-rule="evenodd"
                         clip-rule="evenodd"
                         d="M15.0028 15.4648C16.916 14.3602 17.5715 11.9138 16.4669 10.0007C15.3623 8.0875 12.916 7.432 11.0028 8.53657C9.08962 9.64114 7.56809 12.5875 8.67266 14.5007C9.67814 16.2422 13.5 16.3324 15.0028 15.4648ZM12.8274 12C13.6558 12 15 11.5791 15 10.7507C15 9.92224 14.1558 9 13.3274 9C12.499 9 11.3125 9.92224 11.3125 10.7507C11.3125 11.5791 11.999 12 12.8274 12ZM13.7656 12.7902C13.2298 12.9238 12.9037 13.4665 13.0373 14.0024C13.1709 14.5383 13.7136 14.8644 14.2495 14.7308C14.7854 14.5971 15.4757 13.4483 15.342 12.9124C15.2187 12.4176 14.4358 12.6185 13.8947 12.7573L13.8946 12.7574L13.8944 12.7574C13.8497 12.7689 13.8066 12.78 13.7656 12.7902ZM11.7374 13.4353C12.0085 13.8554 11.8594 14.5466 11.4392 14.8177C11.019 15.0888 10.3279 14.9396 10.0568 14.5195C9.78574 14.0993 9.36022 13.1838 10.0839 12.7169C10.8077 12.25 11.4663 13.0151 11.7374 13.4353Z"
                         fill="#B6D477"
                         />
                         </svg>'
                    ),
                ...
                #     <div>Analysing female patients treated </div>
                #     
